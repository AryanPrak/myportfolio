...
const Hero = () => {
  return (
    ...
    <div className='flex justify-center relative my-20 z-10'>
      <div className='max-w-[89vw] md:max-w-2x-l lg:max-w-[60vw] flex flex-col items-center justify-center'>

        <p className='uppercase tracking-widest text-xs text-center text-blue-100 max-w-80'>
          Dynamic Web Magic With Next.JS
        </p>
        <TextGenerateEffect words='Helping Your Business Grow Online' 
        className="text-center text-[40px] md:text-5xl lg:text-6xl"/>

        <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
          Hi I'm Aranya Welcome To My Portfolio</p>
          <a href='#'>
            <MagicButton title='Lets Get Started' icon={<FaLocationArrow/>} position={'right'} otherClasses={''}/>
           </a>
      </div>
    </div>
      <div>
