    ...
    return (
        <section className="w-full py-20">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
                <Card title="Planning & Statergy"
                    desc="We'll collaborate to map out your Application goals, target audience, 
                ...
                <Card title="Development & Launch"
                    desc="This is where the magic happens! Based on the approved design, 
                        I'll translate everything into functional code, building your App/Website
                        from the ground up."
